                    ...
                    <div className="max-w-4xl animate-in slide-in-from-left-10 duration-700">
                        ...
                        <div className="flex gap-6">
                            <button
                                ...
                                className="bg-white text-black px-12 py-5 rounded-2xl font-black text-xl uppercase tracking-widest outline-none focus:bg-neon-cyan focus:scale-110 transition-all flex items-center gap-4"
                            >
                            ...
                            <button
                                ...
                                className="bg-white/10 backdrop-blur-md text-white px-10 py-5 rounded-2xl font-black text-xl uppercase tracking-widest outline-none focus:bg-white focus:text-black focus:scale-110 transition-all border-2 border-white/20 flex items-center gap-4"
                            >
